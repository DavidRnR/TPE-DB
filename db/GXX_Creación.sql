...
DROP TABLE IF EXISTS GXX_Departamento CASCADE;
DROP TABLE IF EXISTS GXX_Tipo_Dpto CASCADE;
DROP TABLE IF EXISTS GXX_Habitacion CASCADE;
DROP TABLE IF EXISTS GXX_CostoDepto CASCADE;
DROP TABLE IF EXISTS GXX_Reserva CASCADE;
DROP TABLE IF EXISTS GXX_Pago CASCADE;
DROP TABLE IF EXISTS GXX_Tipo_Pago CASCADE;
DROP TABLE IF EXISTS GXX_EstadoLuegoOcupacion CASCADE;
DROP TABLE IF EXISTS GXX_Huesped CASCADE;
DROP TABLE IF EXISTS GXX_Huesped_Reserva CASCADE;
DROP TABLE IF EXISTS GXX_Persona CASCADE;
DROP TABLE IF EXISTS GXX_Comentario CASCADE;
